...
and visualizes enhancer/overlap regions. You can specify directories via command-line arguments.
"""
...
# Argument parsing for flexible directories
parser = argparse.ArgumentParser(description="Compare merged BED files and visualize overlaps.")
parser.add_argument("--data_dir", type=str, default=rf"C:\Users\izzye\OneDrive - Johns Hopkins\Documents\BRIGHT\seq\{distance}\k={k}", help="Directory containing merged BED files.")
parser.add_argument("--output_dir", type=str, default=r"C:\Users\izzye\OneDrive - Johns Hopkins\Documents\BRIGHT\seq\csv", help="Directory to save CSV summary tables.")
parser.add_argument("--comp_dir", type=str, default=r"C:\Users\izzye\OneDrive - Johns Hopkins\Documents\BRIGHT\seq\images\overlap_plots", help="Directory to save overlap plots.")
parser.add_argument("--heat_dir", type=str, default=r"C:\Users\izzye\OneDrive - Johns Hopkins\Documents\BRIGHT\seq\images\heatmaps", help="Directory to save heatmaps.")
...
heat_dir = args.heat_dir

# List of merged BED files to process
files = [
    "st10_merged_sorted.bed",
    "st10R_merged_sorted.bed",
    "IntP2A_merged_sorted.bed",
    "IntP2B_merged_sorted.bed",
    "pCRM_merged_sorted.bed",
    "Peak9820_merged_sorted.bed",
