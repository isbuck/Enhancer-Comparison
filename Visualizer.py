...
You can specify the data directory and other options via command-line arguments.
"""
...
from Matching_Enhancers import k, distance, pval

# Argument parsing for flexible data directory and options
parser = argparse.ArgumentParser(description="Visualize k-mer distance results and compute p-values.")
parser.add_argument("--data_dir", type=str, default=rf"C:\Users\izzye\OneDrive - Johns Hopkins\Documents\BRIGHT\seq\{distance}\k={k}", help="Directory containing BedGraph files.")
...
results_bed = subprocess.run(["python", "Bedtools.py"])
